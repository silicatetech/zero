...
All commits must carry a `Signed-off-by` trailer certifying that the author
has the right to submit the work under the project's license. This is the
[Developer Certificate of Origin](DCO) used by the Linux kernel and many
other open-source projects.

Add it automatically with `git commit -s`, or append manually:
...
- **Description:** explain *what* changed and *why*. Link any relevant ADR in
  [`docs/adr/`](docs/adr/). If you change behavior, say how you verified it.
