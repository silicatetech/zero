...
> The kernel boots in **release** mode only. Debug builds collide with bootloader identity-mapping. See [ADR-028](docs/adr/028-boot-llm-architecture-v0.md).
...
│   ├── zero-llm-inference/ # reference inference engine
│   └── kernel-tests/          # host-buildable kernel test harness (43 tests)
│
├── tools/
...
| [`adr/`](docs/adr/) | Architecture Decision Records (ADR-001 through ADR-037) |

## Roadmap

| Phase | Milestone | Status |
|---|---|---|
| 1 | Language and Validation | Done |
| 2 | Boot-LLM + Cross-Platform ARM | Done |
| 3 | Sandboxing + Quarks Kernel Migration | Next |
| 4 | MCP Integration | Planned |
| 5 | Dual Desktop UI | Planned |
| 6 | Storage Subsystem | Planned |
| 7 | VM Hosting (Linux/Windows guests) | Planned |
